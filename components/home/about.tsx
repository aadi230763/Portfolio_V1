...
const AboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-3xl sm:text-4xl md:text-6xl">
      ...
      >
        I build reliable, scalable AI systems by combining deep technical understanding with purposeful design.{" "}
      </span>
      <span
      ...
      >
        From system architecture to execution, I leverage Agentic AI and Deep Learning to turn complex problems into maintainable, high-impact tools.
      </span>
    </h1>
  );
